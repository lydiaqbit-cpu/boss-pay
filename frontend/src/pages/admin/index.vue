...
// #ifdef H5
function drawCharts() {
  drawLineChart('reg-chart', regData.value, '#D94F3D')
...
function drawLineChart(id: string, data: { label: string; count: number }[], color: string) {
  ...
  // 网格线
  ctx.strokeStyle = '#E5D8C4'; ctx.lineWidth = 0.5
  for (let i = 0; i <= 4; i++) {
...
.secret-input {
  ...
  border: 1rpx solid #C8B89A; padding: 0 24rpx; font-size: 28rpx; color: #1E1A14;
  box-sizing: border-box; margin-bottom: 24rpx;
}
.ph { color: #C4A882; }
.btn-login {
  width: 100%; height: 96rpx; background: #1E1A14; color: #F7F4F0;
...
.ov-card {
  ...
  border: 1rpx solid #C8B89A; text-align: center;
}
.ov-card.red { border-color: #D94F3D; background: #FBF8F5; }
.ov-card.gold { border-color: #C4A882; background: #F8F5F2; }
.ov-val { font-size: 44rpx; font-weight: 900; color: #1E1A14; display: block; }
.ov-card.red .ov-val { color: #D94F3D; }
.ov-card.gold .ov-val { color: #A8402E; }
...
.period-tab {
  ...
  background: #fff; border-radius: 6rpx; border: 1rpx solid #C8B89A; color: #8B7355;
}
.period-tab.active { background: #1E1A14; color: #F7F4F0; border-color: #1E1A14; font-weight: 700; }

/* 图表卡 */
.chart-card {
  background: #fff; border-radius: 8rpx; padding: 28rpx;
  border: 1rpx solid #C8B89A; margin-bottom: 20rpx;
}
...
.bar { width: 100%; background: #D94F3D; border-radius: 4rpx 4rpx 0 0; min-height: 4rpx; }
...
.legend-row { display: flex; justify-content: space-between; padding: 10rpx 0; border-bottom: 1rpx solid #E5D8C4; }
.legend-date { font-size: 24rpx; color: #6B5040; }
.legend-val { font-size: 24rpx; color: #D94F3D; font-weight: 700; }

/* 事件排行 */
.event-row { display: flex; align-items: center; gap: 16rpx; padding: 14rpx 0; border-bottom: 1rpx solid #E5D8C4; }
.event-row:last-child { border-bottom: none; }
.event-name { font-size: 24rpx; color: #1E1A14; width: 180rpx; flex-shrink: 0; }
.event-bar-wrap { flex: 1; background: #F0EAE2; border-radius: 4rpx; height: 20rpx; overflow: hidden; }
.event-bar { height: 100%; background: #D94F3D; border-radius: 4rpx; transition: width 0.4s; min-width: 4rpx; }
.event-count { font-size: 24rpx; color: #8B7355; width: 60rpx; text-align: right; flex-shrink: 0; }

/* 用户列表 */
.user-row { display: flex; align-items: center; gap: 16rpx; padding: 16rpx 0; border-bottom: 1rpx solid #E5D8C4; }
.user-row:last-child { border-bottom: none; }
.u-avatar {
  width: 72rpx; height: 72rpx; border-radius: 36rpx; flex-shrink: 0;
  background: #F0EAE2; display: flex; align-items: center; justify-content: center;
  overflow: hidden; border: 1rpx solid #C8B89A;
}
.u-img { width: 72rpx; height: 72rpx; }
.u-abbr { font-size: 28rpx; color: #A8402E; font-weight: 700; }
.u-info { flex: 1; }
...
.load-more { text-align: center; padding: 24rpx; color: #A8402E; font-size: 26rpx; }
</style>
